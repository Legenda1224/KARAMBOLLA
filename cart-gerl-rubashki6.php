...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, Объемная рубашка из хлопка, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Объемная рубашка из хлопка от 3 999 рублей">
    <meta charset="UTF-8">
    ...
    <title>Объемная рубашка из хлопка</title>
</head>
<body>
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-rubashki11.png" alt="">
        <img src="img/cart-rubashki12.png" alt="">
    </div>
    <div class="card">
        <h3>
            Объемная рубашка из хлопка
        </h3>
        <p>
