...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, Платье-комбинация из лиоцелла, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Платье-комбинация из лиоцелла от 1 199 рублей">
    <meta charset="UTF-8">
    ...
    <title>Платье-комбинация из лиоцелла</title>
</head>
<body>
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-gerl-children-platye7.png" alt="">
        <img src="img/cart-gerl-children-platye8.png" alt="">
    </div>
    <div class="card">
        <h3>
            Платье-комбинация из лиоцелла
        </h3>
        <p>
