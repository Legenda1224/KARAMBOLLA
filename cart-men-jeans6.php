...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, Джинсы Patrick slim fit Ultra Soft Touch, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Джинсы Patrick slim fit Ultra Soft Touch от 6 999 рублей">
    <meta charset="UTF-8">
    ...
    <title>Джинсы Patrick slim fit Ultra Soft Touch</title>
</head>
<body>
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-jeans11.png" alt="">
        <img src="img/cart-jeans12.png" alt="">
    </div>
    <div class="card">
        <h3>
            Джинсы Patrick slim fit Ultra Soft Touch
        </h3>
        <p>
