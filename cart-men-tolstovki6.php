...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, Свитшот Тьяго с принтом, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Свитшот Тьяго с принтом от 4 999 руб">
    <meta charset="UTF-8">
    ...
    <title>Свитшот Тьяго с принтом</title>
</head>
<body>
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-tolstovki11.png" alt="">
        <img src="img/cart-tolstovki12.png" alt="">
    </div>
    <div class="card">
        <h3>
            Свитшот Тьяго с принтом
        </h3>
        <p>
