...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, Объемная рубашка из лиоцелла, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Объемная рубашка из лиоцелла от 4 999 рублей">
    <meta charset="UTF-8">
    ...
    <title>Объемная рубашка из лиоцелла</title>
</head>
<body>
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-rubashki9.png" alt="">
        <img src="img/cart-rubashki10.png" alt="">
    </div>
    <div class="card">
        <h3>
            Объемная рубашка из лиоцелла
        </h3>
        <p>
