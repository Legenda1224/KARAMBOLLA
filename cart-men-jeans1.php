...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, Джинсы Ben tapered fit, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Джинсы Ben tapered fit от 6 999 рублей">
    <meta charset="UTF-8">
    ...
    <title>Джинсы Ben tapered fit</title>
</head>
<body>
...
<div class="container_cart">
    <div class="d-flex__cart">
        <div class="cart">
            <img src="img/cart-jeans1.png" alt="">
            <img src="img/cart-jeans2.png" alt="">
        </div>
        <div class="card">
            <h3>
                Джинсы Ben tapered fit
            </h3>
            <p>
                APT. 27041136-BEN-LH
            </p>
