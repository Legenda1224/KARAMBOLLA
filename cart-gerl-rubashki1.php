...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, Струящаяся атласная блузка, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Струящаяся атласная блузка от 4 999 рублей">
    <meta charset="UTF-8">
    ...
    <title>Струящаяся атласная блузка</title>
</head>
<body>
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-rubashki1.png" alt="">
        <img src="img/cart-rubashki2.png" alt="">
    </div>
    <div class="card">
        <h3>
            Струящаяся атласная блузка
        </h3>
        <p>
