...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, Трикотажный свитшот в полоску, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин трикотажный свитшот в полоску от 8 999 руб">
    <meta charset="UTF-8">
    ...
    <title>Трикотажный свитшот в полоску</title>
</head>
<body>
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-tolstovki9.png" alt="">
        <img src="img/cart-tolstovki10.png" alt="">
    </div>
    <div class="card">
        <h3>
            Трикотажный свитшот в полоску
        </h3>
        <p>
            APT. 27075744-GLOBO-LH
        </p>
