...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, Блейзер с декоративными пуговицами, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Блейзер с декоративными пуговицами от 9 999 рублей">
    <meta charset="UTF-8">
    ...
    <title>Блейзер с декоративными пуговицами</title>
</head>
<body>
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-gerl-pidshak1.png" alt="">
        <img src="img/cart-gerl-pidshaki2.png" alt="">
    </div>
    <div class="card">
        <h3>
