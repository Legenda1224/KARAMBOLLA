...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, Брюки regular-fit с защипами, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Брюки regular-fit с защипами от 4 999 рублей">
    <meta charset="UTF-8">
    ...
    <title>Брюки regular-fit с защипами</title>
</head>
<body>
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-bruki5.png" alt="">
        <img src="img/cart-bruki6.png" alt="">
    </div>
    <div class="card">
        <h3>
            Брюки regular-fit с защипами
        </h3>
        <p>
