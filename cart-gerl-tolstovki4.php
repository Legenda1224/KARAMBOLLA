...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, Комбинированный джемпер, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Комбинированный джемпер от 8 999 рублей">
    <meta charset="UTF-8">
    ...
    <title>Комбинированный джемпер</title>
</head>
<body>
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-gerl-tolstovki7.png" alt="">
        <img src="img/cart-gerl-tolstovki8.png" alt="">
    </div>
    <div class="card">
        <h3>
            Комбинированный джемпер
        </h3>
        <p>
