...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, Облегающий костюмный пиджак, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Облегающий костюмный пиджак от 6 999 рублей">
    <meta charset="UTF-8">
    ...
    <title>Облегающий костюмный пиджак</title>
</head>
<body>
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-gerl-pidshak3.png" alt="">
        <img src="img/cart-gerl-pidshak4.png" alt="">
    </div>
    <div class="card">
        <h3>
            Облегающий костюмный пиджак
        </h3>
        <p>
