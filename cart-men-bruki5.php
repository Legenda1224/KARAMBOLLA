...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, Укороченные брюки tapered из хлопка, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Укороченные брюки tapered из хлопка от 4 999 рублей">
    <meta charset="UTF-8">
    ...
    <title>Укороченные брюки tapered из хлопка</title>
</head>
<body>
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-bruki9.png" alt="">
        <img src="img/cart-bruki10.png" alt="">
    </div>
    <div class="card">
        <h3>
            Укороченные брюки tapered из хлопка
        </h3>
        <p>
            APT. 27040866-GORRYST-LH
        </p>
