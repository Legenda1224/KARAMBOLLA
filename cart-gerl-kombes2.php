...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, Комбинезон из денима с рукавами, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Комбинезон из денима с рукавами от 16 999 рублей">
    <meta charset="UTF-8">
    ...
    <title>Комбинезон из денима с рукавами</title>
</head>
<body>
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-gerl-kombes3.png" alt="">
        <img src="img/cart-gerl-kombes4.png" alt="">
    </div>
    <div class="card">
        <h3>
            Комбинезон из денима с рукавами
        </h3>
        <p>
