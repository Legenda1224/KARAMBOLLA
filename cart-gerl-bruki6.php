...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, Брюки с геометрическим принтом, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Брюки с геометрическим принтом от 6 999 рублей">
    <meta charset="UTF-8">
    ...
    <title>Брюки с геометрическим принтом</title>
</head>
<body>
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-bruki-11.png" alt="">
        <img src="img/cart-bruki-12.png" alt="">
    </div>
    <div class="card">
        <h3>
            Брюки с геометрическим принтом
        </h3>
        <p>
