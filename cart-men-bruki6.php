...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, Брюки slim fit из хлопка, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Брюки slim fit из хлопка от 6 999 рублей">
    <meta charset="UTF-8">
    ...
    <title>Брюки slim fit из хлопка</title>
</head>
<body>
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-bruki11.png" alt="">
        <img src="img/cart-bruki12.png" alt="">
    </div>
    <div class="card">
        <h3>
