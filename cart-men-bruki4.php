...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, Брюки loose-fit с защипами, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Брюки loose-fit с защипами от 8 999 рублей">
    <meta charset="UTF-8">
    ...
    <title>Брюки loose-fit с защипами</title>
</head>
<body>
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-bruki7.png" alt="">
        <img src="img/cart-bruki8.png" alt="">
    </div>
    <div class="card">
        <h3>
            Брюки loose-fit с защипами
        </h3>
        <p>
