...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, Джинсы Bob straight-fit светлого цвета, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Джинсы Bob straight-fit светлого цвета от 6 999 рублей">
    <meta charset="UTF-8">
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-jeans5.png" alt="">
        <img src="img/cart-jeans6.png" alt="">
    </div>
    <div class="card">
        <h3>
            Джинсы Bob straight-fit светлого цвета
        </h3>
        <p>
