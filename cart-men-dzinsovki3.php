...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, Верхняя рубашка с карманами, хлопок, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Верхняя рубашка с карманами, хлопок от 3 599 рублей">
    <meta charset="UTF-8">
    ...
    <title>Верхняя рубашка с карманами, хлопок</title>
</head>
<body>
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-dzinsovki7.png" alt="">
        <img src="img/cart-dzinsovki8.png" alt="">
    </div>
    <div class="card">
        <h3>
            Верхняя рубашка с карманами, хлопок
        </h3>
        <p>
