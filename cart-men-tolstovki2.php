...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, Кожаная куртка с карманами, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Кожаная куртка с карманами от 34 999 рублей">
    <meta charset="UTF-8">
    ...
    <title>Кожаная куртка с карманами</title>
</head>
<body>
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-tolstovki3.png" alt="">
        <img src="img/cart-tolstovki4.png" alt="">
    </div>
    <div class="card">
        <h3>
