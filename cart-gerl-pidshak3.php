...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, Пиджак из шерсти в клетку, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Пиджак из шерсти в клетку от 13 999 рублей">
    <meta charset="UTF-8">
    ...
    <title>Пиджак из шерсти в клетку</title>
</head>
<body>
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-gerl-pidshak5.png" alt="">
        <img src="img/cart-gerl-pidshak6.png" alt="">
    </div>
    <div class="card">
        <h3>
            Пиджак из шерсти в клетку
        </h3>
        <p>
