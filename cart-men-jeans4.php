...
<html lang="en">
<head>
    <meta name="keywords" content="KARAMBOLLA, Верхняя Джинсы Patrick slim fit Ultra Soft Touch
    из пестрого денима  новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Верхняя Джинсы Patrick slim fit Ultra Soft Touch
    из пестрого денима от 8 999 рублей">
    <meta charset="UTF-8">
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-jeans9.png" alt="">
        <img src="img/cart-jeans10.png" alt="">
    </div>
    <div class="card">
        <h3>
            Верхняя Джинсы Patrick slim fit Ultra<br>
            Soft Touch
            из пестрого денима
