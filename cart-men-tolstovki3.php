...
<html lang="en">
<head>
    <meta name="keywords" content="KARAMBOLLA, Свитшот с капюшоном, хлопок новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Свитшот с капюшоном, хлопок от 3 499 рублей">
    <meta charset="UTF-8">
    ...
    <title>Свитшот с капюшоном, хлопок</title>
</head>
<body>
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-tolstovki5.png" alt="">
        <img src="img/cart-tolstovki6.png" alt="">
    </div>
    <div class="card">
        <h3>
            Свитшот с капюшоном, хлопок
        </h3>
        <p>
