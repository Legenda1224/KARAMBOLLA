...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, ЖЕНСКИЕ РУБАШКИ, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин женские рубашки">
    <meta charset="UTF-8">
...
<div class="container_cart">
    <div class="cart__flex">
        <div class="cart">
            <a href="cart-gerl-rubashki1.php"><img src="img/gerl-rubashki.png" alt=""></a>            
            <i class="fa-solid fa-heart cart-heart"></i>
            <i class="fa-solid fa-cart-shopping cart-basket"></i>
            <p>4999 руб</p>
        </div>
        <div class="cart">
            <a href="cart-gerl-rubashki2.php"><img src="img/gerl-rubashki2.png" alt=""></a>
            <i class="fa-solid fa-heart cart-heart"></i>
            <i class="fa-solid fa-cart-shopping cart-basket"></i>
            <p>3999 руб</p>
        </div>
        <div class="cart">
            <a href="cart-gerl-rubashki3.php"><img src="img/gerl-rubashki3.png" alt=""></a>
            <i class="fa-solid fa-heart cart-heart"></i>
            <i class="fa-solid fa-cart-shopping cart-basket"></i>
            <p>3999 руб</p>
        </div>
        <div class="cart">
            <a href="cart-gerl-rubashki4.php"><img src="img/gerl-rubashki4.png" alt=""></a>
            <i class="fa-solid fa-heart cart-heart"></i>
            <i class="fa-solid fa-cart-shopping cart-basket"></i>
            <p>4999 руб</p>
        </div>
        <div class="cart">
           <a href="cart-gerl-rubashki5.php"><img src="img/gerl-rubashki5.png" alt=""></a>
            <i class="fa-solid fa-heart cart-heart"></i>
            <i class="fa-solid fa-cart-shopping cart-basket"></i>
            <p>3999 руб</p>
        </div>
        <div class="cart">
            <a href="cart-gerl-rubashki6.php"><img src="img/gerl-rubashki6.png" alt=""></a>
            <i class="fa-solid fa-heart cart-heart"></i>
            <i class="fa-solid fa-cart-shopping cart-basket"></i>
            <p>3999 руб</p>
        </div>
