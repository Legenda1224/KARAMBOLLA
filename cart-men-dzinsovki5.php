...
<html lang="en">
<head>
    <meta name="keywords" content="KARAMBOLLA, Верхняя рубашка в клетку из переработанного хлопка, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Верхняя рубашка в клетку из переработанного хлопка от 6 999 рублей">
    <meta charset="UTF-8">
    ...
    <title>Верхняя рубашка в клетку из переработанного хлопка</title>
</head>
<body>
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-dzinsovki9.png" alt="">
        <img src="img/cart-dzinsovki10.png" alt="">
    </div>
    <div class="card">
        <h3>
            Верхняя рубашка в клетку из <br>
            переработанного хлопка
        </h3>
        <p>
