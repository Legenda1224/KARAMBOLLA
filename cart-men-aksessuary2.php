...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, Вязаная шапочка, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Вязаная шапочка от 1 599 рублей">
    <meta charset="UTF-8">
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-aksessuary3.png" alt="">
        <img src="img/cart-aksessuary4.png" alt="">
    </div>
    <div class="card">
        <h3>
            Вязаная шапочка
