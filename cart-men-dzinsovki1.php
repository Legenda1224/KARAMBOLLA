...
<html lang="en">
<head>
    <meta name="keywords" content="KARAMBOLLA, Ветровка из переработанной шерсти, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Ветровка из переработанной шерсти от 12 499 рублей">
    <meta charset="UTF-8">
    ...
    <title>Ветровка из переработанной шерсти</title>
</head>
<body>
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-dzinsovki3.png" alt="">
        <img src="img/cart-dzinsovki4.png" alt="">
    </div>
    <div class="card">
        <h3>
            Ветровка из переработанной шерсти
        </h3>
        <p>
