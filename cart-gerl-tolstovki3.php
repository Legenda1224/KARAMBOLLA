...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, Комбинированный бомбер, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Комбинированный бомбер от 6 999 рублей">
    <meta charset="UTF-8">
    ...
    <title>Комбинированный бомбер</title>
</head>
<body>
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-gerl-tolstovki5.png" alt="">
        <img src="img/cart-gerl-tolstovki6.png" alt="">
    </div>
    <div class="card">
        <h3>
            Комбинированный бомбер
        </h3>
        <p>
