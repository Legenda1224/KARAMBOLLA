...
<meta name="keywords" content="KARAMBOLLA, Полушерстяные перчатки с кожаными вставками, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Полушерстяные перчатки с кожаными вставками от 1 799 рублей">
    <meta charset="UTF-8">
    ...
    <title>Полушерстяные перчатки с кожаными</title>
</head>
<body>
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-aksessuary5.png" alt="">
        <img src="img/cart-aksessuary6.png" alt="">
    </div>
    <div class="card">
        <h3>
