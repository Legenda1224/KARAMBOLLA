...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, МУЖСКИЕ ДЖИНСЫ, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин мужские джинсы">
    <meta charset="UTF-8">
...
<div class="container_cart">
    <div class="cart__flex">
        <div class="cart">
            <a href="cart-men-jeans1.php"><img src="img/men-jeans.png" alt=""></a>            
            <i class="fa-solid fa-heart cart-heart"></i>
            <i class="fa-solid fa-cart-shopping cart-basket"></i>
            <p>6999 руб</p>
        </div>
        <div class="cart">
            <a href="cart-men-jeans2.php"><img src="img/men-jeans2.png" alt=""></a>
            <i class="fa-solid fa-heart cart-heart"></i>
            <i class="fa-solid fa-cart-shopping cart-basket"></i>
            <p>3999 руб</p>
        </div>
        <div class="cart">
            <a href="cart-men-jeans3.php"><img src="img/men-jeans3.png" alt=""></a>
            <i class="fa-solid fa-heart cart-heart"></i>
            <i class="fa-solid fa-cart-shopping cart-basket"></i>
            <p>7899 руб</p>
        </div>
        <div class="cart">
            <a href="cart-men-jeans4.php"><img src="img/men-jeans4.png" alt=""></a>
            <i class="fa-solid fa-heart cart-heart"></i>
            <i class="fa-solid fa-cart-shopping cart-basket"></i>
            <p>2890 руб</p>
        </div>
        <div class="cart">
           <a href="cart-men-jeans5.php"><img src="img/men-jeans5.png" alt=""></a>
            <i class="fa-solid fa-heart cart-heart"></i>
            <i class="fa-solid fa-cart-shopping cart-basket"></i>
            <p>6799 руб</p>
        </div>
        <div class="cart">
            <a href="cart-men-jeans6.php"><img src="img/men-jeans6.png" alt=""></a>
            <i class="fa-solid fa-heart cart-heart"></i>
            <i class="fa-solid fa-cart-shopping cart-basket"></i>
            <p>4599 руб</p>
        </div>
