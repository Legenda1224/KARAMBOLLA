...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, ЖЕНСКИЕ КОМБИНЕЗОНЫ  новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин женские комбинезоны">
    <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="stylesheet" href="css/gerl-kombes1.css">
    ...
    <title>Женщины Комбинезоны</title>
</head>
<body>
...
<div class="container_cart">
    <div class="cart__flex">
        <div class="cart">
            <a href="cart-gerl-kombes1.php"><img src="img/gerl-kombes1.png" alt=""></a>            
            <i class="fa-solid fa-heart cart-heart"></i>
            <i class="fa-solid fa-cart-shopping cart-basket"></i>
            <p>6999 руб</p>
        </div>
        <div class="cart">
            <a href="cart-gerl-kombes2.php"><img src="img/gerl-kombes2.png" alt=""></a>
            <i class="fa-solid fa-heart cart-heart"></i>
            <i class="fa-solid fa-cart-shopping cart-basket"></i>
            <p>16999 руб</p>
        </div>
        <div class="cart">
            <a href="cart-gerl-kombes3.php"><img src="img/gerl-kombes3.png" alt=""></a>
            <i class="fa-solid fa-heart cart-heart"></i>
            <i class="fa-solid fa-cart-shopping cart-basket"></i>
            <p>8999 руб</p>
        </div>
        <div class="cart">
            <a href="cart-gerl-kombes4.php"><img src="img/gerl-kombes4.png" alt=""></a>
            <i class="fa-solid fa-heart cart-heart"></i>
            <i class="fa-solid fa-cart-shopping cart-basket"></i>
            <p>6999 руб</p>
        </div>
        <div class="cart">
            <a href="cart-gerl-kombes5.php"><img src="img/gerl-kombes5.png" alt=""></a>
            <i class="fa-solid fa-heart cart-heart"></i>
            <i class="fa-solid fa-cart-shopping cart-basket"></i>
            <p>8999 руб</p>
        </div>
