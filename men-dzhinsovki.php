...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, МУЖСКИЕ ДЖИНСОВКИ, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин мужские джинсовки">
    <meta charset="UTF-8">
...
<div class="container_cart">
    <div class="cart__flex">
        <div class="cart">
            <a href="cart-men-dzinsovki1.php"><img src="img/men-dzinsovki.png" alt=""></a>            
            <i class="fa-solid fa-heart cart-heart"></i>
            <i class="fa-solid fa-cart-shopping cart-basket"></i>
            <p>6999 руб</p>
        </div>
        <div class="cart">
            <a href="cart-men-dzinsovki2.php"><img src="img/men-dzinsovki2 (2).png" alt=""></a>
            <i class="fa-solid fa-heart cart-heart"></i>
            <i class="fa-solid fa-cart-shopping cart-basket"></i>
            <p>3999 руб</p>
        </div>
        <div class="cart">
            <a href="cart-men-dzinsovki3.php"><img src="img/men-dzinsovki3 (2).png" alt=""></a>
            <i class="fa-solid fa-heart cart-heart"></i>
            <i class="fa-solid fa-cart-shopping cart-basket"></i>
            <p>7899 руб</p>
        </div>
        <div class="cart">
            <a href="cart-men-dzinsovki4.php"><img src="img/men-dzinsovki4.png" alt=""></a>
            <i class="fa-solid fa-heart cart-heart"></i>
            <i class="fa-solid fa-cart-shopping cart-basket"></i>
            <p>2890 руб</p>
        </div>
        <div class="cart">
            <a href="cart-men-dzinsovki5.php"><img src="img/men-dzinsovki5 (2).png" alt=""></a>
            <i class="fa-solid fa-heart cart-heart"></i>
            <i class="fa-solid fa-cart-shopping cart-basket"></i>
            <p>6799 руб</p>
        </div>
        <div class="cart">
           <a href="cart-men-dzinsovki6.php"><img src="img/men-dzinsovki6.png" alt=""></a>
            <i class="fa-solid fa-heart cart-heart"></i>
            <i class="fa-solid fa-cart-shopping cart-basket"></i>
            <p>4599 руб</p>
        </div>
