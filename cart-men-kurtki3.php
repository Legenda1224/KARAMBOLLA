...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, Непромокаемый стеганый жилет, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Непромокаемый стеганый жилет от 6 999 рублей">
    <meta charset="UTF-8">
    ...
    <title>Непромокаемый стеганый жилет</title>
</head>
<body>
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-kurtki5.png" alt="">
        <img src="img/cart-kurtki6.png" alt="">
    </div>
    <div class="card">
        <h3>
            Непромокаемый стеганый жилет
        </h3>
        <p>
