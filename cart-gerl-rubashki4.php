...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, Рубашка с принтованными цепочками, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Рубашка с принтованными цепочками от 4 999 рублей">
    <meta charset="UTF-8">
    ...
    <title>Рубашка с принтованными цепочками</title>
</head>
<body>
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-rubashki7.png" alt="">
        <img src="img/cart-rubashki8.png" alt="">
    </div>
    <div class="card">
        <h3>
            Рубашка с принтованными цепочками
        </h3>
        <p>
