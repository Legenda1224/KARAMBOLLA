...
<head>
    ...
    новинки, женщины, мужчины, подростки, дети, Женское, Комбинезоны, Рубашки, 
    Пиджаки, Куртки, Толстовки, Брюки, Мужчины">
    <meta name="description" content="        <strong>
            KARAMBOLLA  
        </strong> | женщины женская одежда куртки,
    толстовки, рубашки, комбинезоны">
    <meta charset="UTF-8">
...
<main class="main">
    ...
    <div class="cart">
        ...
        <div class="cart">
            <div class="cart_img">
                <img src="img/gerl3.png" alt="">
            </div>
            <div class="linear">
                <a href="gerl-tolstovki.php">Подробнее</a>
            </div>
            <h3>
                Толстовки
            </h3>
        ...
        <div class="cart">
            <div class="cart_img">
                <img src="img/gerl4.png" alt="">
            </div>
            <div class="linear">
                <a href="gerl-bruki.php">Подробнее</a>
            </div>
            <h3>
                Брюки
            </h3>
