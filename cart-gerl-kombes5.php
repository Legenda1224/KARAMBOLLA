...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, Комбинезон с драпированной горловиной, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Комбинезон с драпированной горловиной от 8 999 рублей">
    <meta charset="UTF-8">
    ...
    <title>Комбинезон с драпированной горловиной</title>
</head>
<body>
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-gerl-kombes9.png" alt="">
        <img src="img/cart-gerl-kombes10.png" alt="">
    </div>
    <div class="card">
        <h3>
            Комбинезон с драпированной <br>горловиной
        </h3>
        <p>
