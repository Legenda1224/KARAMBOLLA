...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, Атласное платье-комбинация, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Атласное платье-комбинация от 2 199 рублей">
    <meta charset="UTF-8">
    ...
    <title>Атласное платье-комбинация</title>
</head>
<body>
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-gerl-children-platye9.png" alt="">
        <img src="img/cart-gerl-children-platye10.png" alt="">
    </div>
    <div class="card">
        <h3>
            Атласное платье-комбинация
        </h3>
        <p>
