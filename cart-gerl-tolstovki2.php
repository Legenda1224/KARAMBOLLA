...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, Хлопковый свитшот с вышивкой, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Хлопковый свитшот с вышивкой от 3 999 рублей">
    <meta charset="UTF-8">
    ...
    <title>Хлопковый свитшот с вышивкой</title>
</head>
<body>
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-gerl-tolstovki3.png" alt="">
        <img src="img/cart-gerl-tolstovki4.png" alt="">
    </div>
    <div class="card">
        <h3>
            Хлопковый свитшот с вышивкой
        </h3>
        <p>
