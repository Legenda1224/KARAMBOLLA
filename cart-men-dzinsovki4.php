...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, Верхняя рубашка из пестрого денима, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Верхняя рубашка из пестрого денима от 8 900 рублей">
    <meta charset="UTF-8">
    ...
    <title>Верхняя рубашка из пестрого денима</title>
</head>
<body>
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-dzinsovki1.png" alt="">
        <img src="img/cart-dzinsovki2.png" alt="">
    </div>
    <div class="card">
        <h3>
            Верхняя рубашка из пестрого денима
        </h3>
        <p>
