...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, Фактурное платье из хлопка, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Фактурное платье из хлопка от 2 999 рублей">
    <meta charset="UTF-8">
    ...
    <title>Фактурное платье из хлопка</title>
</head>
<body>
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-gerl-children-platye1.png" alt="">
        <img src="img/cart-gerl-children-platye2.png" alt="">
    </div>
    <div class="card">
        <h3>
            Фактурное платье из хлопка
        </h3>
        <p>
