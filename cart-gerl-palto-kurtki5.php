...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, Джинсовая куртка с необработанными краями, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Джинсовая куртка с необработанными краями от 6 999 рублей">
    <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="stylesheet" href="css/cart-gerl-bruki.css">
    ...
    <title>Джинсовая куртка с необработанными краями</title>
</head>
<body>
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-gerl-palto-kurtki9.png" alt="">
        <img src="img/cart-gerl-palto-kurtki10.png" alt="">
    </div>
    <div class="card">
        <h3>
            Джинсовая куртка с необработанными <br>
            краями
        </h3>
        <p>
            APT. 27021103-DUBLINO-LH
        </p>
