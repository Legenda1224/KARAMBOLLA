...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, Верхняя рубашка worker из вельвета, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Верхняя рубашка worker из вельвета от 5 699 рублей">
    <meta charset="UTF-8">
    ...
    <title>Верхняя рубашка worker из вельвета</title>
</head>
<body>
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-dzinsovki5.png" alt="">
        <img src="img/cart-dzinsovki6.png" alt="">
    </div>
    <div class="card">
        <h3>
            Верхняя рубашка worker из вельвета
        </h3>
        <p>
