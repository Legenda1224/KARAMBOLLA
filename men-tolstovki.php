...
<html lang="en">
<head>
    <meta name="keywords" content="KARAMBOLLA, Мужчины Толстовки, МУЖСКИЕ ТОЛСТОВКИ,
    новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Мужские Толстовки ">
    <meta charset="UTF-8">
...
<div class="container_cart">
    <div class="cart__flex">
        <div class="cart">
            <a href="cart-men-tolstovki1.php"><img src="img/men-tolstovki.png" alt=""></a>
            <i class="fa-solid fa-heart cart-heart"></i>
            <i class="fa-solid fa-cart-shopping cart-basket"></i>
            <p>3 999 руб</p>
        </div>
        <div class="cart">
            <a href="cart-men-tolstovki2.php"><img src="img/men-tolstovki2.png" alt=""></a>
            <i class="fa-solid fa-heart cart-heart"></i>
            <i class="fa-solid fa-cart-shopping cart-basket"></i>
            <p>34 999 руб</p>
        </div>
        <div class="cart">
            <a href="cart-men-tolstovki3.php"><img src="img/men-tolstovki3.png" alt=""></a>
            <i class="fa-solid fa-heart cart-heart"></i>
            <i class="fa-solid fa-cart-shopping cart-basket"></i>
            <p>3 499 руб</p>
        </div>
        <div class="cart">
            <a href="cart-men-tolstovki4.php"><img src="img/men-tolstovki4.png" alt=""></a>
            <i class="fa-solid fa-heart cart-heart"></i>
            <i class="fa-solid fa-cart-shopping cart-basket"></i>
            <p>6 999 руб</p>
        </div>
        <div class="cart">
            <a href="cart-men-tolstovki5.php"><img src="img/men-tolstovki5 (2).png" alt=""></a>
            <i class="fa-solid fa-heart cart-heart"></i>
            <i class="fa-solid fa-cart-shopping cart-basket"></i>
            <p>8 999 руб</p>
        </div>
        <div class="cart">
            <a href="cart-men-tolstovki6.php"><img src="img/men-tolstovki6.png" alt=""></a>
            <i class="fa-solid fa-heart cart-heart"></i>
            <i class="fa-solid fa-cart-shopping cart-basket"></i>
            <p>4 999 руб</p>
        </div>
