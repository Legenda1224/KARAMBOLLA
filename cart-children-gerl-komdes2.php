...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, Полукомбинезон кюлот из денима, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Полукомбинезон кюлот из денима от 3 999 рублей">
    <meta charset="UTF-8">
    ...
    <title>Полукомбинезон кюлот из денима</title>
</head>
<body>
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-gerl-children-kombes3.png" alt="">
        <img src="img/cart-gerl-children-kombes4.png" alt="">
    </div>
    <div class="card">
        <h3>
            Полукомбинезон кюлот из денима
        </h3>
        <p>
