...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, МУЖСКИЕ АКСЕССУАРЫ, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин мужские аксессуары">
    <meta charset="UTF-8">
    ...
    <title>Мужчины Аксессуары</title>
</head>
<body>
...
<div class="container_cart">
    <div class="cart__flex">
        <div class="cart">
            <a href="cart-men-aksessuary1.php"><img src="img/men-aksessuary.png" alt=""></a>           
            <i class="fa-solid fa-heart cart-heart"></i>
            <i class="fa-solid fa-cart-shopping cart-basket"></i>
            <p>6999 руб</p>
        </div>
        <div class="cart">
            <a href="cart-men-aksessuary2.php"><img src="img/men-aksessuary2.png" alt=""></a>
            <i class="fa-solid fa-heart cart-heart"></i>
            <i class="fa-solid fa-cart-shopping cart-basket"></i>
            <p>3999 руб</p>
        </div>
        <div class="cart">
            <a href="cart-men-aksessuary3.php"><img src="img/men-aksessuary3.png" alt=""></a>
            <i class="fa-solid fa-heart cart-heart"></i>
            <i class="fa-solid fa-cart-shopping cart-basket"></i>
            <p>7899 руб</p>
        </div>
        <div class="cart">
            <a href="cart-men-aksessuary4.php"><img src="img/men-aksessuary4.png" alt=""></a>
            <i class="fa-solid fa-heart cart-heart"></i>
            <i class="fa-solid fa-cart-shopping cart-basket"></i>
            <p>2890 руб</p>
        </div>
        <div class="cart">
            <a href="cart-men-aksessuary5.php"><img src="img/men-aksessuary5.png" alt=""></a>
            <i class="fa-solid fa-heart cart-heart"></i>
            <i class="fa-solid fa-cart-shopping cart-basket"></i>
            <p>6799 руб</p>
        </div>
        <div class="cart">
            <a href="cart-men-aksessuary6.php"><img src="img/men-aksessuary6.png" alt=""></a>
            <i class="fa-solid fa-heart cart-heart"></i>
            <i class="fa-solid fa-cart-shopping cart-basket"></i>
            <p>4599 руб</p>
        </div>
