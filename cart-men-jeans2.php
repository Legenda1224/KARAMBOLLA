...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, Джинсы-скинни Jude светлого цвета, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Джинсы-скинни Jude светлого цвета от 4 999 рублей">
    <meta charset="UTF-8">
    ...
    <title>Джинсы-скинни Jude светлого цвета</title>
</head>
<body>
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-jeans3.png" alt="">
        <img src="img/cart-jeans4.png" alt="">
    </div>
    <div class="card">
        <h3>
            Джинсы-скинни Jude светлого цвета
        </h3>
        <p>
