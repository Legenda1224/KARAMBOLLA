...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, Структурированный пиджак с прорезями, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Структурированный пиджак с прорезями от 17 999 рублей">
    <meta charset="UTF-8">
    ...
    <title>Структурированный пиджак с прорезями</title>
</head>
<body>
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-gerl-pidshak7.png" alt="">
        <img src="img/cart-gerl-pidshak8.png" alt="">
    </div>
    <div class="card">
        <h3>
            Структурированный пиджак с прорезями
        </h3>
        <p>
