...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, Джинсовая куртка с бахромой, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Джинсовая куртка с бахромой от 6 999 рублей">
    <meta charset="UTF-8">
    ...
    <title>Джинсовая куртка с бахромой</title>
</head>
<body>
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-gerl-palto-kurtki3.png" alt="">
        <img src="img/cart-gerl-palto-kurtki4.png" alt="">
    </div>
    <div class="card">
        <h3>
            Джинсовая куртка с бахромой
        </h3>
        <p>
