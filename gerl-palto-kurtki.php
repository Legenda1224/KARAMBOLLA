...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, ЖЕНСКИЕ ПАЛЬТО И КУРТКИ, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин женскиое пальто и куртки ">
    <meta charset="UTF-8">
    ...
    <title>Женщины Пальто и Куртки</title>
</head>
<body>
...
<div class="container_cart">
    <div class="cart__flex">
        <div class="cart">
            <a href="cart-gerl-palto-kurtki1.php"><img src="img/gerl-palto-kurtki.png" alt=""></a>            
            <i class="fa-solid fa-heart cart-heart"></i>
            <i class="fa-solid fa-cart-shopping cart-basket"></i>
            <p>16999 руб</p>
        </div>
        <div class="cart">
            <a href="cart-gerl-palto-kurtki2.php"><img src="img/gerl-palto-kurtki2.png" alt=""></a>
            <i class="fa-solid fa-heart cart-heart"></i>
            <i class="fa-solid fa-cart-shopping cart-basket"></i>
            <p>6999 руб</p>
        </div>
        <div class="cart">
            <a href="cart-gerl-palto-kurtki3.php"><img src="img/gerl-palto-kurtki3.png" alt=""></a>
            <i class="fa-solid fa-heart cart-heart"></i>
            <i class="fa-solid fa-cart-shopping cart-basket"></i>
            <p>12499 руб</p>
        </div>
        <div class="cart">
            <a href="cart-gerl-palto-kurtki4.php"><img src="img/gerl-palto-kurtki4.png" alt=""></a>
            <i class="fa-solid fa-heart cart-heart"></i>
            <i class="fa-solid fa-cart-shopping cart-basket"></i>
            <p>6999 руб</p>
        </div>
        <div class="cart">
           <a href="cart-gerl-palto-kurtki5.php"><img src="img/gerl-palto-kurtki5.png" alt=""></a>
            <i class="fa-solid fa-heart cart-heart"></i>
            <i class="fa-solid fa-cart-shopping cart-basket"></i>
            <p>6999 руб</p>
        </div>
        <div class="cart">
            <a href="cart-gerl-palto-kurtki6.php"><img src="img/gerl-palto-kurtki6.png" alt=""></a>
            <i class="fa-solid fa-heart cart-heart"></i>
            <i class="fa-solid fa-cart-shopping cart-basket"></i>
            <p>6999 руб</p>
        </div>
