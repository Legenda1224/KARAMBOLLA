...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, ТОСТОВКИ, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин женские толстовки">
    <meta charset="UTF-8">
...
<div class="container_cart">
    <div class="cart__flex">
        <div class="cart">
            <a href="cart-gerl-tolstovki1.php"><img src="img/gerl-tolstovki1.png" alt=""></a>            
            <i class="fa-solid fa-heart cart-heart"></i>
            <i class="fa-solid fa-cart-shopping cart-basket"></i>
            <p>3999 руб</p>
        </div>
        <div class="cart">
            <a href="cart-gerl-tolstovki2.php"><img src="img/gerl-tolstovki2.png" alt=""></a>
            <i class="fa-solid fa-heart cart-heart"></i>
            <i class="fa-solid fa-cart-shopping cart-basket"></i>
            <p>3999 руб</p>
        </div>
        <div class="cart">
            <a href="cart-gerl-tolstovki3.php"><img src="img/gerl-tolstovki3.png" alt=""></a>
            <i class="fa-solid fa-heart cart-heart"></i>
            <i class="fa-solid fa-cart-shopping cart-basket"></i>
            <p>6999 руб</p>
        </div>
        <div class="cart">
            <a href="cart-gerl-tolstovki4.php"><img src="img/gerl-tolstovki4.png" alt=""></a>
            <i class="fa-solid fa-heart cart-heart"></i>
            <i class="fa-solid fa-cart-shopping cart-basket"></i>
            <p>8999 руб</p>
        </div>
