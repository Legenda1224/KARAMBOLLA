...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, Комбинированная верхняя рубашка, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Комбинированная верхняя рубашка от 6 999 рублей">
    <meta charset="UTF-8">
    ...
    <title>Комбинированная верхняя рубашка</title>
</head>
<body>
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-gerl-palto-kurtki7.png" alt="">
        <img src="img/cart-gerl-palto-kurtki8.png" alt="">
    </div>
    <div class="card">
        <h3>
            Комбинированная верхняя рубашка
        </h3>
        <p>
