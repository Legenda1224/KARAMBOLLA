...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, Двубортный пиджак в клетку, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Двубортный пиджак в клетку от 8 999 рублей">
    <meta charset="UTF-8">
    ...
    <title>Двубортный пиджак в клетку</title>
</head>
<body>
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-gerl-pidshak9.png" alt="">
        <img src="img/cart-gerl-pidshak10.png" alt="">
    </div>
    <div class="card">
        <h3>
            Двубортный пиджак в клетку
        </h3>
        <p>
