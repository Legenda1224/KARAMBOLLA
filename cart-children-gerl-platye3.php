...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, Платье с цветочным принтом, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Платье с цветочным принтом от 3 999 рублей">
    <meta charset="UTF-8">
    ...
    <title>Платье с цветочным принтом</title>
</head>
<body>
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-gerl-children-platye5.png" alt="">
        <img src="img/cart-gerl-children-platye6.png" alt="">
    </div>
    <div class="card">
        <h3>
