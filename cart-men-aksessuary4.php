...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, Полушерстяные перчатки с кожаными вставками, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-Полушерстяные перчатки с кожаными вставками от 1 599 рублей">
    <meta charset="UTF-8">
    ...
    <title>Полушерстяные перчатки с кожаными вставками</title>
</head>
<body>
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-aksessuary7.png" alt="">
        <img src="img/cart-aksessuary8.png" alt="">
    </div>
    <div class="card">
        <h3>
            Полушерстяные перчатки с кожаными<br>
            вставками
        </h3>
        <p>
            APT. 27084390-ZIRCON-LH
        </p>
