...
<meta name="keywords" content="KARAMBOLLA, Короткая вязаная шапка, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Короткая вязаная шапка от 1 599 рублей">
    <meta charset="UTF-8">
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-aksessuary9.png" alt="">
        <img src="img/cart-aksessuary10.png" alt="">
    </div>
    <div class="card">
        <h3>
