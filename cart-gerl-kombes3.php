...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, Длинный комбинезон с ремешком, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Длинный комбинезон с ремешком от 8 999 рублей">
    <meta charset="UTF-8">
    ...
    <title>Длинный комбинезон с ремешком</title>
</head>
<body>
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-gerl-kombes5.png" alt="">
        <img src="img/cart-gerl-kombes6.png" alt="">
    </div>
    <div class="card">
        <h3>
            Длинный комбинезон с ремешком
        </h3>
        <p>
