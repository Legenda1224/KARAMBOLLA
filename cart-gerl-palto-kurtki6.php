...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, Приталенный пиджак базовой модели, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Приталенный пиджак базовой модели от 6 999 рублей">
    <meta charset="UTF-8">
    ...
    <title>Приталенный пиджак базовой модели</title>
</head>
<body>
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-gerl-palto-kurtki11.png" alt="">
        <img src="img/cart-gerl-palto-kurtki12.png" alt="">
    </div>
    <div class="card">
        <h3>
            Приталенный пиджак базовой модели
        </h3>
        <p>
