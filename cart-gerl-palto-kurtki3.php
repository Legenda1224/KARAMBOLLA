...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, Меховое пальто оверсайз, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Меховое пальто оверсайз от 12 499 рублей">
    <meta charset="UTF-8">
    ...
    <title>Меховое пальто оверсайз</title>
</head>
<body>
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-gerl-palto-kurtki5.png" alt="">
        <img src="img/cart-gerl-palto-kurtki6.png" alt="">
    </div>
    <div class="card">
        <h3>
            Меховое пальто оверсайз
        </h3>
        <p>
