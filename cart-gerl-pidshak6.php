...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, Двубортный костюмный пиджак, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Двубортный костюмный пиджак от 6 999 рублей">
    <meta charset="UTF-8">
    ...
    <title>Двубортный костюмный пиджак</title>
</head>
<body>
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-gerl-pidshak11.png" alt="">
        <img src="img/cart-gerl-pidshak12.png" alt="">
    </div>
    <div class="card">
        <h3>
            Двубортный костюмный пиджак
        </h3>
        <p>
