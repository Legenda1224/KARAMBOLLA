...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, Верхняя рубашка из замши с карманами, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Верхняя рубашка из замши с карманами от 26 999 рублей">
    <meta charset="UTF-8">
    ...
    <title>Верхняя рубашка из замши с карманами</title>
</head>
<body>
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-kurtki7.png" alt="">
        <img src="img/cart-kurtki8.png" alt="">
    </div>
    <div class="card">
        <h3>
            Верхняя рубашка из замши с карманами
        </h3>
        <p>
            APT. 27084384-GARDEN-LH
        </p>
