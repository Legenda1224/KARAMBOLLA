...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, Базовый свитшот из хлопка, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Базовый свитшот из хлопка от 3 999 рублей">
    <meta charset="UTF-8">
    ...
    <title>Базовый свитшот из хлопка</title>
</head>
<body>
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-tolstovki1.png" alt="">
        <img src="img/cart-tolstovki2.png" alt="">
    </div>
    <div class="card">
        <h3>
            Базовый свитшот из хлопка
        </h3>
        <p>
