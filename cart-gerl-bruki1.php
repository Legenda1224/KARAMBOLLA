...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, Брюки с эластичным поясом из искусственной кожи, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Брюки с эластичным поясом из искусственной кожи от 4 999 рублей">
    <meta charset="UTF-8">
    ...
    <title>Брюки с эластичным поясом из икуссвенной кожи</title>
</head>
<body>
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-bruki-1.png" alt="">
        <img src="img/cart-bruki-2.png" alt="">
    </div>
    <div class="card">
        <h3>
            Брюки с эластичным поясом из <br>
            искусственной кожи
        </h3>
        <p>
