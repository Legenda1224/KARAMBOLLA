...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, МУЖСКИЕ БРЮКИ, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин мужские брюки">
    <meta charset="UTF-8">
...
<div class="container_cart">
    <div class="cart__flex">
        <div class="cart">
            <a href="cart-men-bruki1.php"><img src="img/cart-men-bruki1.png" alt=""></a>            
            <i class="fa-solid fa-heart cart-heart"></i>
            <i class="fa-solid fa-cart-shopping cart-basket"></i>
            <p>6999 руб</p>
        </div>
        <div class="cart">
            <a href="cart-men-bruki2.php"><img src="img/cart-men-bruki2.png" alt=""></a>
            <i class="fa-solid fa-heart cart-heart"></i>
            <i class="fa-solid fa-cart-shopping cart-basket"></i>
            <p>4990 руб</p>
        </div>
        <div class="cart">
            <a href="cart-men-bruki3.php"><img src="img/cart-men-bruki3.png" alt=""></a>
            <i class="fa-solid fa-heart cart-heart"></i>
            <i class="fa-solid fa-cart-shopping cart-basket"></i>
            <p>4999 руб</p>
        </div>
        <div class="cart">
            <a href="cart-men-bruki4.php"><img src="img/cart-men-bruki4.png" alt=""></a>
            <i class="fa-solid fa-heart cart-heart"></i>
            <i class="fa-solid fa-cart-shopping cart-basket"></i>
            <p>2890 руб</p>
        </div>
        <div class="cart">
           <a href="cart-men-bruki5.php"><img src="img/cart-men-bruki5.png" alt=""></a>
            <i class="fa-solid fa-heart cart-heart"></i>
            <i class="fa-solid fa-cart-shopping cart-basket"></i>
            <p>4999 руб</p>
        </div>
        <div class="cart">
            <a href="cart-men-bruki6.php"><img src="img/cart-men-bruki6.png" alt=""></a>
            <i class="fa-solid fa-heart cart-heart"></i>
            <i class="fa-solid fa-cart-shopping cart-basket"></i>
            <p>4599 руб</p>
        </div>
