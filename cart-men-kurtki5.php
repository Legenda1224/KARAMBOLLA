...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, Короткий анорак с терморегуляцией, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Короткий анорак с терморегуляцией от 6 999 рублей">
    <meta charset="UTF-8">
    ...
    <title>Короткий анорак с терморегуляцией</title>
</head>
<body>
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-kurtki9.png" alt="">
        <img src="img/cart-kurtki10.png" alt="">
    </div>
    <div class="card">
        <h3>
            Короткий анорак с терморегуляцией
        </h3>
        <p>
