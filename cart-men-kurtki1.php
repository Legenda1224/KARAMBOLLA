...
<html lang="en">
<head>
    <meta name="keywords" content="ARAMBOLLA, Непромокаемая дышащая куртка, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Непромокаемая дышащая куртка от 12 499 рублей">
    <meta charset="UTF-8">
    ...
    <title>Непромокаемая дышащая куртка</title>
</head>
<body>
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-kurtki1.png" alt="">
        <img src="img/cart-kurtki2.png" alt="">
    </div>
    <div class="card">
        <h3>
            Непромокаемая дышащая куртка
        </h3>
        <p>
            APT. 27094381-ROSIER-LH
        </p>
