...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, Короткая вязаная шапка, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Короткая вязаная шапка от 3 499 рублей">
    <meta charset="UTF-8">
    ...
    <title>Короткая вязаная шапка</title>
</head>
<body>
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-aksessuary1.png" alt="">
        <img src="img/cart-aksessuary2.png" alt="">
    </div>
    <div class="card">
        <h3>
            Короткая вязаная шапка
        </h3>
        <p>
