...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, КОМБИНЕЗОНЫ, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин детские комбинезоны">
    <meta charset="UTF-8">
    ...
    <title>Девочки комбинезоны</title>
</head>
<body>
...
<div class="container_cart">
    <div class="cart__flex">
        <div class="cart">
            <a href="cart-children-gerl-komdes1.php"><img src="img/gerl-children-kombes1.png" alt=""></a>            
            <i class="fa-solid fa-heart cart-heart"></i>
            <i class="fa-solid fa-cart-shopping cart-basket"></i>
            <p>4599 руб</p>
        </div>
        <div class="cart">
            <a href="cart-children-gerl-komdes2.php"><img src="img/gerl-children-kombes2.png" alt=""></a>
            <i class="fa-solid fa-heart cart-heart"></i>
            <i class="fa-solid fa-cart-shopping cart-basket"></i>
            <p>3999 руб</p>
        </div>
        <div class="cart">
            <a href="cart-children-gerl-komdes3.php"><img src="img/gerl-children-kombes3.png" alt=""></a>
            <i class="fa-solid fa-heart cart-heart"></i>
            <i class="fa-solid fa-cart-shopping cart-basket"></i>
            <p>3999 руб</p>
        </div>
