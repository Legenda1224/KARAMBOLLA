...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, Объемная куртка-бомбер, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Объемная куртка-бомбер от 16 999 рублей">
    <meta charset="UTF-8">
    ...
    <title>Объемная куртка-бомбер</title>
</head>
<body>
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-gerl-palto-kurtki1.png" alt="">
        <img src="img/cart-gerl-palto-kurtki2.png" alt="">
    </div>
    <div class="card">
        <h3>
            Объемная куртка-бомбер
        </h3>
        <p>
