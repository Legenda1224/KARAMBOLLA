...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, Платье с вышивкой и перфорацией, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Платье с вышивкой и перфорацией от 4 499 рублей">
    <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="stylesheet" href="css/cart-children-platye1.css">
    ...
    <title>Платье с вышивкой и перфорацией</title>
</head>
<body>
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-gerl-children-platye3.png" alt="">
        <img src="img/cart-gerl-children-platye4.png" alt="">
    </div>
    <div class="card">
        <h3>
            Платье с вышивкой и перфорацией
        </h3>
        <p>
