...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, Двусторонний костюмный ремень из кожы, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Двусторонний костюмный ремень из кожы от 4 999 рублей">
    <meta charset="UTF-8">
    ...
    <title>Двусторонний костюмный ремень из кожи</title>
</head>
<body>
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-aksessuary11.png" alt="">
        <img src="img/cart-aksessuary12.png" alt="">
    </div>
    <div class="card">
        <h3>
            Двусторонний костюмный ремень <br>
            из кожи
        </h3>
        <p>
            APT. 17010013-EMILI-LH
        </p>
