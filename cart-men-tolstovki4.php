...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, Хлопковый свитшот с нашивкой, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Хлопковый свитшот с нашивкой от 6 999 руб">
    <meta charset="UTF-8">
    ...
    <title>Хлопковый свитшот с нашивкой</title>
</head>
<body>
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-tolstovki7.png" alt="">
        <img src="img/cart-tolstovki8.png" alt="">
    </div>
    <div class="card">
        <h3>
            Хлопковый свитшот с нашивкой
        </h3>
        <p>
