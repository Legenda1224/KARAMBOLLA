...
<html lang="en">
<head>
<meta name="keywords" content="KARAMBOLLA, Объёмная хлопковая толстовка, новинки, женщины, мужчины, подростки, дети">
    <meta name="description" content="KARAMBOLLA интернет-магазин Объёмная хлопковая толстовка от 3 999 рублей">
    <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="stylesheet" href="css/cart-gerl-tolstovki.css">
    ...
    <title>Объёмная хлопковая толстовка</title>
</head>
<body>
...
<div class="d-flex__cart">
    <div class="cart">
        <img src="img/cart-gerl-tolstovki1.png" alt="">
        <img src="img/cart-gerl-tolstovki2.png" alt="">
    </div>
    <div class="card">
        <h3>
            Объёмная хлопковая толстовка
        </h3>
        <p>
